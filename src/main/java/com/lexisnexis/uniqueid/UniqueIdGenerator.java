...
/**
 * This is an implementation of Globally Unique Transaction ID.
...
public class UniqueIdGenerator {
     ...
     * @return String
     */
    public String getUniqueIdAsString(byte[] uid) {
        return bytesToBase58(uid);
    }
     ...
     * @return String
     */
    public byte[] getBinaryUniqueIdFromStringFormat(String uidStr) {
        return base58Tobytes(uidStr);
    }
